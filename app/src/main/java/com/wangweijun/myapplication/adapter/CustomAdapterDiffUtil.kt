...
class CustomAdapterDiffUtil(private val context: Context, private val dataSet: ArrayList<MyModel>) : RecyclerView.Adapter<CustomAdapterDiffUtil.CustomViewHolder>() {
    companion object {
         const val tag = "duanxia"
    }
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
        ...
        val myModel = dataSet[position]
        holder.textView.text = myModel.title
        holder.textView.setBackgroundColor(context.getColor(myModel.colorResId))
